...
import static cz.fit.dpo.mvcshooter.model.ModelConfig.STRING_LINE_SEPARATOR;
...
public class GraphicsDrawer implements Visitor {
  ...
  public void visit(Score score) {
    int y = score.getY();
    for (String line : score.print().split(STRING_LINE_SEPARATOR)) {
      g.drawString(line, score.getX(), y += g.getFontMetrics().getHeight());
    }
  }
